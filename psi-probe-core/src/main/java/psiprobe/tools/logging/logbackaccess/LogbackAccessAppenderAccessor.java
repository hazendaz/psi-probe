 ...
 */
public class LogbackAccessAppenderAccessor extends AbstractLogDestination {

  /** The logger accessor. */
  private LogbackAccessLoggerAccessor loggerAccessor;
   ...
   */
  public LogbackAccessLoggerAccessor getLoggerAccessor() {
   ...
   */
  public void setLoggerAccessor(LogbackAccessLoggerAccessor loggerAccessor) {
